import Logo from "../../public/pieces/wN.svg";

export default function NavBar() {
    return (
        <nav className="backdrop-blur-md bg-opacity-70 bg-[#141414] fixed border-b border-white/10 top-0 w-full">
            <div className="container mx-auto px-48 py-4 flex justify-between items-center">
                ...
                <div className="hidden md:flex space-x-6">
                    <a href="#home" className="text-gray-100 hover:text-white transition">Home</a>
